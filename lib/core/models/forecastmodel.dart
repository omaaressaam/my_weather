class Forecasmodel {
  ...
  Forecasmodel({this.location, this.current, this.forecast});

  Forecasmodel.fromJson(Map<String, dynamic> json) {
    location =
        json['location'] != null ? new Loc.fromJson(json['location']) : null;
    current =
